...
@Component({
  ...
  template: `
    <div
      [class]="'mb-4 p-4 border border-border rounded-lg hover:bg-muted/50 transition-colors ' + (clickable ? 'cursor-pointer' : '') + ' ' + (className || '')"
          ...
          <div class="p-2 bg-primary/10 rounded-md border border-primary/20">
            <div class="flex items-center gap-2">
              ...
              <div class="text-xs">
                ...
                <p class="font-medium text-primary">{{ request.collectorName }}</p>
              </div>
            </div>
          </div>
        }
